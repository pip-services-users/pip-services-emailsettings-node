...
var plugin = require('pip-services-emailsettings-node').EmailSettingsSenecaPlugin;
...
or by using [EmailSettingsSenecaClient](https://github.com/pip-services-users/pip-clients-emailsettings-node/NodeClientApiV1.md/#client_seneca)