...
import { EmailSettingsCouchbasePersistence } from '../../src/persistence/EmailSettingsCouchbasePersistence';
import { EmailSettingsPersistenceFixture } from './EmailSettingsPersistenceFixture';

suite('EmailSettingsCouchbasePersistence', ()=> {
    ...
    setup((done) => {
        ...
        persistence = new EmailSettingsCouchbasePersistence();
