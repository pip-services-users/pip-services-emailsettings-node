...
class EmailSettingsServiceFactory extends pip_services_components_node_1.Factory {
    constructor() {
        super();
...
EmailSettingsServiceFactory.Descriptor = new pip_services_commons_node_1.Descriptor("pip-services-emailsettings", "factory", "default", "default", "1.0");
EmailSettingsServiceFactory.MemoryPersistenceDescriptor = new pip_services_commons_node_1.Descriptor("pip-services-emailsettings", "persistence", "memory", "*", "1.0");
EmailSettingsServiceFactory.FilePersistenceDescriptor = new pip_services_commons_node_1.Descriptor("pip-services-emailsettings", "persistence", "file", "*", "1.0");
EmailSettingsServiceFactory.MongoDbPersistenceDescriptor = new pip_services_commons_node_1.Descriptor("pip-services-emailsettings", "persistence", "mongodb", "*", "1.0");
EmailSettingsServiceFactory.ControllerDescriptor = new pip_services_commons_node_1.Descriptor("pip-services-emailsettings", "controller", "default", "*", "1.0");
EmailSettingsServiceFactory.SenecaServiceDescriptor = new pip_services_commons_node_1.Descriptor("pip-services-emailsettings", "service", "seneca", "*", "1.0");
EmailSettingsServiceFactory.HttpServiceDescriptor = new pip_services_commons_node_1.Descriptor("pip-services-emailsettings", "service", "http", "*", "1.0");
